...
OPTI_CFLAGS     := -mtune=cortex-a53 -mcpu=cortex-a53 \
                   --param l1-cache-size=32 --param l1-cache-line-size=64 --param l2-cache-size=2048 -ffast-math
